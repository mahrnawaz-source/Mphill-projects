setwd("C:/Users/hp/Desktop/NUST/NGSA/project2/Dataset for Project 2")
...
dds$type <- relevel(dds$Category, "Control")


#Run DESeq2
#it perform all analysis
dds <- DESeq(dds)
...
#FDR can be lowered
#res.01 <- results(dds, alpha=.01)
#summary(res.01)
res.01 <- results(dds, alpha=.01)
summary(res.01)
#LFC2 and alpha 0.01
#lfc2res.01 <- results(dds, alpha=.01, lfcThreshold=1)
#summary(lfc2res.01)
lfc2res.01 <- results(dds, alpha=.01, lfcThreshold=1)
summary(lfc2res.01)
...
#it will show the most downregulated genes
...
EnhancedVolcano(res,
                ...
                caption = 'log2fc cutoff=1.7; p value cutof=10e-6',
